#define ARRAY_SIZE 697

#ifndef ADDSQ
    #define ADDSQ global
#endif

unsigned short constant char_from [ARRAY_SIZE] =
{
...
unsigned short constant char_to [ARRAY_SIZE] =
{
...
inline unsigned short utf8_to_ushort(ADDSQ const char* achar)
{
...
inline void ushort_to_utf8(unsigned short achar, ADDSQ char* out)
{
    if (achar < 0x007F)
    {
        (*out)=achar;
...
unsigned short utf8_to_lower_ushort(ADDSQ const char* achar)
{
    ...
    constant unsigned short* l = (constant unsigned short*)char_from;
    constant unsigned short* r = (constant unsigned short*)char_from + ARRAY_SIZE;
    constant unsigned short* s = 0;
...
inline size_t utf8_next_char_count(char c)
{
